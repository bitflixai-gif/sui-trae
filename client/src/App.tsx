...
import { Wallet, Package, TrendingUp, Users, LogOut, Loader2, ArrowUpRight } from 'lucide-react'
          ...
          {packages.map(pkg => (
            <div key={pkg.id} className="package-card">
              ...
              <ul className="pkg-features">
                ...
                <li><span>Total Return</span> <strong>{parseFloat(pkg.roi_percent) * pkg.duration_days}%</strong></li>
              </ul>
